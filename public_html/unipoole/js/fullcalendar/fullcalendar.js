...
//TODO: isFunction, grep ?
    ...
    function BasicView(element, calendar, viewName) {
        ...
        function buildCellHTML(date) {
            ...
            if (showNumbers) {
                // UNIPOOLE - add link on days in month display
                html += "<div class='fc-day-number'><a href='#' class='dayLink'>" + date.getDate() + "</a></div>";
            }
...
// TODO: test liquid width, especially in IE6
    ...
    function AgendaView(element, calendar, viewName) {
        ...
        function buildDayTable() {
            ...
            // UNIPOOLE - open day view on header clicked
            $('.fc-week-head-link').click(function(e) {
                var dateClicked = $(e.target).data('date');
                calendar.changeView('agendaDay');
                calendar.gotoDate(new Date(Date.parse(dateClicked)));
            });
        ...
        function buildDayTableHeadHTML() {
            ...
            // UNIPOOLE - add click functionality on week agenda day headers
            for (col = 0; col < colCnt; col++) {
                date = cellToDate(0, col);
                html +=
                        "<th class='fc-" + dayIDs[date.getDay()] + " fc-col" + col + ' ' + headerClass + "'><a class='fc-week-head-link' data-date='" + formatDate(date, 'u') + "' href='#'>" +
                        htmlEscape(formatDate(date, colFormat)) +
                        "</a></th>";
            }
    ...
    function AgendaEventRenderer() {
        ...
        function slotSegHtml(event, seg) {
            ...
            html +=
                    ...
                    ">" +
                    // UNI
                    "<div class='fc-event-inner " + event.type + "'>" +
